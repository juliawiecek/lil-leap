...
public class CustomerProfile {
    ...
    /** Creates an empty customer profile for onboarding or JPA hydration. */
    ...
    /**
     * Returns encrypted SSN bytes produced by the SSN encryption service, never plaintext.
     * @return encrypted SSN bytes produced by the SSN encryption service, never plaintext
     */
    ...
    /**
     * Sets encrypted SSN bytes produced by the SSN encryption service, never plaintext.
     * @param ssnEncrypted encrypted SSN bytes produced by the SSN encryption service, never plaintext
     */
