...
class RegistrationPersistenceTest {
    ...
    @Import({RegistrationService.class, RegistrationController.class, SsnEncryptionService.class, GlobalExceptionHandler.class})
    static class Config {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"/clients/register", "/api/v1/users"})
